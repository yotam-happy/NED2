...
if __name__ == "__main__":
    ...
    wikiCachedDb = WikipediaDbWrapperCached()
    wikiCachedDb.fillCache(wikiDB, user='yotam', password='rockon123', database='wiki20151002')
    wikiCachedDb.save('dbwrapper_dump')
